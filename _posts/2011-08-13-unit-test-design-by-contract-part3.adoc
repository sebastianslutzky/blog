= Unit testing with Design By Contract (part 3)
:showtitle:
:page-navtitle: Unit Test & Design By Contract (III)
:page-root: ../../../
:experimental:
:imagesdir: /images 
...
_This article is the last of three on http://sebastianslutzky.com/2011/08/08/unit-testing-with-design-by-contract/[Unit Testing and Design By Contract]_
